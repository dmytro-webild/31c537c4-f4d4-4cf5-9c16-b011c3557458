...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      mediaItems={[
        ...
        },
        {
          ...
          imageAlt: "Beautiful blonde woman in white hoodie and blue jeans posing against neon background",
        },
        {
        ...
        },
        {
          ...
          imageAlt: "Vertical photo of young lady leaning on wall at the tunnel",
        },
      ]}
      ...
      bulletPoints={[
        {
          ...
          description: "Eco-conscious fabrics built for the future.",
        },
        {
          title: "Drop Culture",
          description: "Limited edition gear that moves with you.",
        },
        {
  ...
  <div id="features" data-section="features">
      ...
      features={[
        ...
        {
          title: "Hyper-Durable",
          description: "Built to last through every skate session.",
          phoneOne: {
            imageSrc: "http://img.b2bpic.net/free-photo/fabric-texture-background_1388-107.jpg",
            imageAlt: "durable fabric detail stitching",
          },
          phoneTwo: {
        ...
        },
        {
          ...
          description: "Every drop includes a digital collectible.",
          phoneOne: {
            imageSrc: "http://img.b2bpic.net/free-photo/3d-shape-glowing-with-bright-holographic-colors_23-2151037295.jpg",
            imageAlt: "digital fashion collectible graphic",
          },
          phoneTwo: {
      ...
      products={[
        {
          ...
          imageAlt: "product shot hoodie studio black",
        },
        {
          id: "p2",
          name: "Tech Joggers",
          price: "$75",
          imageSrc: "http://img.b2bpic.net/free-photo/view-beige-tone-colored-pants_23-2150773390.jpg",
          imageAlt: "tech joggers studio product photography",
        },
        {
          id: "p3",
          name: "Neon Tee",
          ...
          imageAlt: "graphic t-shirt studio photography",
        },
        {
          id: "p4",
          name: "Vibe Bomber",
          price: "$120",
          imageSrc: "http://img.b2bpic.net/free-photo/american-modern-talk-shirt-male-success_1303-2945.jpg",
          imageAlt: "bomber jacket streetwear product shot",
        },
        {
          id: "p5",
          name: "Street Cap",
          price: "$30",
          imageSrc: "http://img.b2bpic.net/free-vector/vintage-skull-word-design-vector_53876-80913.jpg",
          imageAlt: "baseball cap product photography studio",
        },
        {
          id: "p6",
          name: "Cargo Pants",
          price: "$95",
          imageSrc: "http://img.b2bpic.net/free-photo/assortment-beige-tone-colored-pants_23-2150773400.jpg",
          imageAlt: "cargo trousers apparel product photography",
        },
      ]}
      ...
      plans={[
        {
          ...
          badge: "Base",
          price: "$9/mo",
          subtitle: "Access to standard drops",
          features: [
            "Early access",
            "Email updates",
          ],
        },
        {
          ...
          badge: "Elite",
          price: "$29/mo",
          subtitle: "Priority for every drop",
          features: [
            "Same-day ship",
            "Private discord",
            "VIP events",
  ...
  <div id="contact" data-section="contact">
      ...
      imageAlt="urban studio environment fashion contact"
    />
  </div>
